module.exports = function(grunt) {
  grunt.initConfig({
    ...
    concat: {
      dist: {
        src: ["styles/global/mixins.scss", "styles/global/*", "styles/snippets/*", "styles/templates/*", "styles/misc/*"],
    ...
    compress: {
      main: {
        ...
        files: [
          {
            src: ['assets/*', 'config/*', 'layout/*', 'locales/*', 'snippets/*', 'templates/*', 'templates/customers/*']
          }
        ]
      }
    },
